...
<body>
                                                    ...
                                                    <asp:GridView ID="GridDefaultUserRights" runat="server" CellSpacing="0" CellPadding="0"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Transfer Out">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lblTransferOutXX" runat="server" Text='<%# Eval("Transferout")%>'></asp:LinkButton>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="LeadsAdminXX" runat="server" Text='<%# Eval("SalesAdmin")%>'></asp:LinkButton>
                                                                </ItemTemplate>
                                                                <FooterTemplate>
    ...
    <div id="tblChangePW1" style="display: none; width: 950px; height: 470px;" class="popup">
        ...
        <div class="scroll1">
         ...
         <br />
      <span class="floarC">
           <asp:Button ID="btnUpda" class="btn btn-warning" runat="server" Text="Update"
                                                    OnClick="btnUpda_Click" /> &nbsp;
                                                     <asp:Button ID="btnClosp" class="btn btn-default " runat="server" Text="Cancel"
